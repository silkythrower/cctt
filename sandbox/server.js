 ...
 * to test functionalities easily without setup an apache server
 *
 *
 */
var fs     = require('fs');
...
var privateKey  = fs.readFileSync('./sandbox/certificates/key.pem', 'utf8');
var certificate = fs.readFileSync('./sandbox/certificates/cert.pem', 'utf8');
...
Object.keys(ifaces).forEach(function (ifname) {
    ...
    ifaces[ifname].forEach(function (iface) {
        ...
        console.log("");
        console.log("Welkom bij CCTT Yasmin Sandbox");
        console.log("");
        console.log("CCTT is te bereiken op : ", "https://localhost:8443");
        //console.log("");
        ...
        if (alias >= 1) {
            console.log("Meerdere ipv4 adressen zijn gevonden ... ");
